...
func (p *Parser) parseLetStatement() *ast.LetStatement {
	...
	//we're skipping expression until we hit ;
...
// /////////
// for parsing string literal
func (p *Parser) parseStringLiteral() ast.Expression {
	return &ast.StringLiteral{Token: p.curToken, Value: p.curToken.Literal}
}

// for parsing array data
...
// for prefix expression like -5,!5
...
func (p *Parser) parseBlockStatement() *ast.BlockStatement {
	...
	p.nextToken() //since currently pointing to {
...
func (p *Parser) peekError(l token.TokenType) {
	msg := fmt.Sprintf("expected next token to be %s but got %s", l, p.peekToken.Type)
	p.errors = append(p.errors, msg)
}
